...
public class IngresarProducto extends JFrame implements ActionListener, FocusListener{
    ...
    public JLabel titulo,nombrecodigo;
    ...
    public IngresarProducto(){
        ...
        titulo = new JLabel("Ingresa un Producto");
     ...
     //   nombrecodigo = new JLabel(RegistrarProducto.snombre1);
     //   nombrecodigo.setBounds(450, 180, 250, 30);
     //   nombrecodigo.setFont(new Font("Calibri Cuerpo", Font.BOLD, 22));
     //   add(nombrecodigo);
        ...
        ImageIcon cajaguardar = new ImageIcon("cajaguardar.png");
        etiqueta2 = new JLabel(cajaguardar);
        etiqueta2.setBounds(650, 400, 280, 280);
        Icon icono2 = new ImageIcon(cajaguardar.getImage().getScaledInstance(etiqueta2.getWidth(), etiqueta2.getHeight(), Image.SCALE_DEFAULT));
        etiqueta2.setIcon(icono2);
        add(etiqueta2);

        actualizar = new JButton("Agregar");
    ...
    public void actionPerformed(ActionEvent e) {
     ...
     //       if(escribcodproducto.equals(1)) {
     //           Producto p1=new Producto();
     //           p1.sumar(RegistrarProducto.sexistencias);
     //           p1.imprimirexistencias(RegistrarProducto.sexistencias);
     //       }
